...
**File naming convention:** MIP files are named `mip-<NNN>-<slug>.md`, where `<NNN>` is a zero-padded 3-digit number and `<slug>` is a short, kebab-case summary of the title (e.g., `mip-001-proposer-selection.md`). When first drafting, use a temporary name like `mip-xxx-<slug>.md`. The MIP manager will assign the final number after reviewing. If your proposal needs diagrams or other assets, place them under `mips/diagrams/mip-<NNN>/`.
...
## Impact
 ...
 > List out other MIPs this MIP is dependent on
...
...
## Security Considerations
 ...
 > - How can this MIP potentially impact the security of the network and its users? How is this impact mitigated?
...
### Suggested deployment timeline
 ...
 > **Optional:** Indicate a future release version as a *rough* estimate for when the community should expect to see this deployed on our networks (e.g., release 1.7).
 > You are responsible for updating this MIP with a better estimate, if any, after the MIP passes the gatekeeper’s design review.
 >
 > - On devnet?
 > - On testnet?
 > - On mainnet?
